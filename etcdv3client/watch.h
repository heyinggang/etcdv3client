...
class WatchOptions : public Options<etcdserverpb::WatchCreateRequest> {
 public:
  auto WithRangeEnd(const std::string& end) -> WatchOptions& {
    setfuncs.push_back([end](etcdserverpb::WatchCreateRequest& req) {
  ...
  auto WithStartRevision(int64_t revision) -> WatchOptions& {
    setfuncs.push_back([revision](etcdserverpb::WatchCreateRequest& req) {
  ...
  auto WithProgressNotify() -> WatchOptions& {
    setfuncs.push_back([](etcdserverpb::WatchCreateRequest& req) {
  ...
  auto WithNoPut() -> WatchOptions& {
    setfuncs.push_back([](etcdserverpb::WatchCreateRequest& req) {
      req.add_filters(etcdserverpb::WatchCreateRequest_FilterType_NOPUT);
    });
    return *this;
  }
  ...
  auto WithNoDelete() -> WatchOptions& {
    setfuncs.push_back([](etcdserverpb::WatchCreateRequest& req) {
      req.add_filters(etcdserverpb::WatchCreateRequest_FilterType_NODELETE);
    });
    return *this;
  }
  ...
  auto WithWatchID(int64_t id) -> WatchOptions& {
    setfuncs.push_back([id](etcdserverpb::WatchCreateRequest& req) {
      req.set_watch_id(id);
    });
    return *this;
  }
...
class WatchInterface {
 public:
  ...
  auto virtual WatchSingle(grpc::ClientContext* context,
                           ...
                           const WatchOptions& options = WatchOptions()) -> std::unique_ptr<grpc::ClientReaderWriterInterface<etcdserverpb::WatchRequest, etcdserverpb::WatchResponse>> = 0;
};
